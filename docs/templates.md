...
- 源码：[apps/http-server-template](https://github.com/sora-soft/sora-node/tree/main/apps/http-server-template)
...
- 源码：[apps/base-cluster-template](https://github.com/sora-soft/sora-node/tree/main/apps/base-cluster-template)
...
- 源码：[apps/account-cluster-template](https://github.com/sora-soft/sora-node/tree/main/apps/account-cluster-template)
