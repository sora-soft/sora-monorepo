...
[@sora-soft/framework API Reference](../globals.md) / IServiceMetaData
...
- [`IWorkerMetaData`](IWorkerMetaData.md)

## Extended by

- [`IServiceRunData`](IServiceRunData.md)
...
[`IWorkerMetaData`](IWorkerMetaData.md).[`alias`](IWorkerMetaData.md#alias)
...
[`IWorkerMetaData`](IWorkerMetaData.md).[`id`](IWorkerMetaData.md#id)
...
[`IWorkerMetaData`](IWorkerMetaData.md).[`name`](IWorkerMetaData.md#name)
...
[`IWorkerMetaData`](IWorkerMetaData.md).[`nodeId`](IWorkerMetaData.md#nodeid)
...
[`IWorkerMetaData`](IWorkerMetaData.md).[`startTime`](IWorkerMetaData.md#starttime)
...
[`IWorkerMetaData`](IWorkerMetaData.md).[`state`](IWorkerMetaData.md#state)
